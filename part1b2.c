...
break;
     ...
     //calculating the time taken to hit the escort ship by the battleship
     const int theta_min = random(0, 30); // generating the minimum angle of elevation of the battleship shell
